      ...
      <div style={s.tabs} className="tabs-row">
        {["all", "todo", "in_progress"].map((f) => (
          <button
            ...
            style={{
              ...s.tab,
              background: filter === f ? "#7c3aed" : "#1e1e2e",
        ...
        >
          ...
          >
            ...
            <div style={s.row}>
              <div style={{ flex: 1 }}>
                <label style={s.label}>
                  Effort (1=easy, 10=hard): {form.effort}
                </label>
                <input
                  type="range"
                  min="1"
                  ...
                  onChange={(e) =>
                    setForm({ ...form, effort: Number(e.target.value) })
                  }
                />
              </div>
              <div style={{ flex: 1 }}>
                <label style={s.label}>
                  Impact (1=low, 10=high): {form.impact}
                </label>
                <input
                  type="range"
                  min="1"
